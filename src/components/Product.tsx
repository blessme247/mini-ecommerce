import { ProductType } from "../Helpers/Context/ProductsProvider"
import { ReducerActionType, ReducerAction } from "../Helpers/Context/CartProvider"
...
const Product = ({ product, dispatch, REDUCER_ACTIONS, inCart }: PropsType): ReactElement => {
    ...
    const content =
        <article className="product">
            ...
            <button onClick={onAddToCart} className="addBtn">Add to Cart</button>
        </article>
